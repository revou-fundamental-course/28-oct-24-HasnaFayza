...
hitung.addEventListener("click", () => {
  ...
  if (bmi < 18.5) {
    ...
    resultKetNumber.innerHTML = "Hasil BMI Kamu diantara 18.5 dan 24.9";
    ...
    resultKetNumber.innerHTML = "Hasil BMI Kamu diantara 25.0 dan 29.9";
    ...
    resultKetNumber.innerHTML = "Hasil BMI Kamu diatas 30.0";
